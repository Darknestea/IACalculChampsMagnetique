...
RAW_CONFIG_YAML_ONLY = 0
RAW_CONFIG_TXT_AND_YAML = 1
RAW_CONFIG_CSV_AND_YAML = 2
...
EXPERIMENT_FULL_PARAM_1K = "full_param_1k"
EXPERIMENT_FULL_PARAM_100 = "full_param_100"
EXPERIMENT_ONLY_LENSES_200 = "only_lenses_200"
EXPERIMENT_ONLY_BPC_200 = "only_bpc_200"
EXPERIMENT_ONLY_APERTURES_200 = "only_apertures_200"
...
RAW_CONFIG = RAW_CONFIG_CSV_AND_YAML

# Parameters

CURRENT_EXPERIMENT = EXPERIMENT_4_4

VERBOSE = VERBOSE_NONE
MODE = MODE_TRAINING_FULL
ELLIPSE_PARAMETER_EXTRACTION_DEFAULT_METHOD = naive_fit_ellipse_v0
CLEANING_OPERATIONS_TO_PERFORM = (PERFORM_SIMULATION | PERFORM_REAL)
...
SPECIFIC_REAL_BEAM_SLICES_FOLDER = "E:\\DaVinci\\Images\\EXP4_4"
...
SCREEN_POSITION = 2.0525
SCREEN_POSITION_CORRECTED = SCREEN_POSITION + 0.43345
SCREEN_SIZE_RATIO = 100
SCREEN_SIZE = 32
SCREEN_DPI = 8
...
CAMERA_POSITION = 2.150
CAMERA_POSITION_CORRECTED = CAMERA_POSITION + 0.43345
...
def RAW_CONFIGURATIONS_INCOMPLETE_CSV(experiment_name):
    return f"{RAW_PATH(experiment_name)}configurations_incomplete.csv"
...
MU_PARAM_YAML_FACTORS = {
    MU_PARAM_BPC_V: 1/1000,
    MU_PARAM_BP1_V: 1/1000,
    MU_PARAM_BP2_V: 1/1000,
}
...
MU_PARAM_SPECIAL_YAML_FUNCTIONS = [
    lambda x, file: (x * 100, MU_PARAM_V0),  # 100 because why not making it 10kv based instead of kv
    lambda x, file: (x * 100, MU_PARAM_V1),
    lambda x, file: (
        x / file[
