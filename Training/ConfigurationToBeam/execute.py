...
if __name__ == '__main__':
    main_specific_tasks()
    experiment = EXPERIMENT_4_4
    model, model_information = load_model(simple_sequential.__name__, MY_ID, 79)
    model.experiment_name = experiment
    execute_model(experiment, MY_ID, 76, model, tuple(model_information[IMAGES_SHAPE_FIELD]),
